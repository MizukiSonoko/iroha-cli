...
_GETACCOUNTASSETS = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='asset_id', full_name='iroha.protocol.GetAccountAssets.asset_id', index=1,
      number=2, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=_b("").decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_QUERY_PAYLOAD = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='created_time', full_name='iroha.protocol.Query.Payload.created_time', index=0,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='creator_account_id', full_name='iroha.protocol.Query.Payload.creator_account_id', index=1,
      number=2, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=_b("").decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    _descriptor.FieldDescriptor(
      name='get_account', full_name='iroha.protocol.Query.Payload.get_account', index=2,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='get_account_signatories', full_name='iroha.protocol.Query.Payload.get_account_signatories', index=3,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='get_account_transactions', full_name='iroha.protocol.Query.Payload.get_account_transactions', index=4,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='get_account_asset_transactions', full_name='iroha.protocol.Query.Payload.get_account_asset_transactions', index=5,
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='get_roles', full_name='iroha.protocol.Query.Payload.get_roles', index=7,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='get_asset_info', full_name='iroha.protocol.Query.Payload.get_asset_info', index=8,
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='query_counter', full_name='iroha.protocol.Query.Payload.query_counter', index=10,
